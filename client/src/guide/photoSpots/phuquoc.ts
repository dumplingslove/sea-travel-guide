export const spots: Record<string, Array<{name:string;where:string;how:string;sampleIndex?:number;sampleCaption?:string}>> = {
  "跨海缆车": [
    ...
    { name:"吻桥日落与蓝调", where:"日落小镇海滨步道走到尽头就是吻桥，两座桥拱在海面上“相吻”；站位：桥中线偏左，让桥面斜线带视觉往远方，或退到拱圈正对位、以拱为框把城镇包进去，面向正西。", how:"日落前30分钟到，多停留30分钟收蓝调——桥身剪影、海面深蓝、岸上街屋点灯、渔舟灯点三重层次；手机开HDR和夜景模式，拍人像时点脸测光避免变成剪影；吻桥与海堤是免费公共区域。", sampleIndex:5, sampleCaption:"吻桥两端在落日处“相吻”剪影，海面渔船如点" },
    { name:"日落小镇彩色街区", where:"日落小镇主街与阶梯巷弄，灵感来自意大利南部地中海小镇，温暖色房屋、阶梯式街景、小巷、拱门、石墙；站在拱门下或阶梯转角，面向彩色建筑。", how:"带上脚架，网美照从街上走过怎么拍怎么美；上午人少好取空景，傍晚可直接衔接去吻桥看日落。", sampleIndex:6, sampleCaption:"日落时分的日落小镇，彩色地中海街区与吻桥尽收眼底" },
  ],
  "星星海滩": [
  ...
  "Khem Beach": [
    ...
    { name:"南端礁石与浅滩", where:"沙滩南端礁石区，退潮时走近礁石，站在浅滩上，面向礁石与远海。", how:"退潮前后浅滩露出、水清见底；蹲低拍水面波纹当前景，礁石当视觉重心，穿防滑的鞋。", sampleIndex:5, sampleCaption:"礁石前景，退潮后清澈的浅滩海水" },
    { name:"清晨海面", where:"沙滩东端，清晨站在沙滩上，面向东方看日出，海面会被染成金黄。", how:"日出前后20分钟天空色彩最丰富；提前确认前往路线，别摸黑跑空。", sampleIndex:6, sampleCaption:"Khem Beach 海面日出，金色阳光洒满海面" },
  ],
  "安泰群岛浮潜": [
    ...
    { name:"白沙滩小岛", where:"跳岛停靠的白色沙滩小岛，站在沙滩一端，面向白色沙滩和身后的棕榈。", how:"趁游船停靠的间隙抓紧拍，人少时沙滩最空；超广角低角度，把细沙的纹理当前景。", sampleIndex:5, sampleCaption:"安泰群岛白色沙滩小岛，游船停靠、棕榈环绕" },
  ],
  "VinWonders": [
  ...
  "Vinpearl Safari": [
    { name:"游览车近距离拍动物", where:"坐游览车进入野生动物区，长颈鹿、斑马靠近车道时，在车上贴着车窗拍，别把手伸出车外。", how:"上午动物最活跃；车在动就开连拍，手机用2x长焦，稳住再按快门。", sampleIndex:5, sampleCaption:"鸵鸟群围在游览车前，车身 Safari 标识清晰可见" },
    { name:"长颈鹿喂食", where:"园内长颈鹿区，买饲料近距离喂食长颈鹿，站在围栏边，面向长颈鹿。", how:"排队人多时先去别处逛一圈再回来；喂食时保持安静、听工作人员指示，别投喂自带食物。", sampleIndex:6, sampleCaption:"小朋友在围栏边给长颈鹿喂胡萝卜" },
    { name:"火烈鸟湖", where:"步行区火烈鸟湖观景台，面向湖面，粉色火烈鸟群在浅水里觅食。", how:"上午顺光羽毛最粉；低角度贴着栏杆拍，把水面倒影一起收进画面。", sampleIndex:7, sampleCaption:"粉色火烈鸟群在湖中浅水觅食" },
  ],
  "Dinh Cau 岩": [
  ...
  "Ham Ninh 渔村": [
    ...
    { name:"日出渔船剪影", where:"Ham Ninh 在东岸，站在码头根部沙滩，面向东方，渔船剪影配朝霞。", how:"日出前后20分钟天空色彩最丰富；手机点测光对准朝霞，船身自然成剪影。", sampleIndex:5, sampleCaption:"Ham Ninh 海面日出，渔船漂浮在粉金色晨光中" },
    { name:"木栈桥晚霞倒影", where:"渔村木栈桥上，面向平静海面。", how:"傍晚水面会映出粉彩色晚霞，倒影配渔船最出片；退潮时可在沙滩边捡贝壳当画面点缀。", sampleIndex:6, sampleCaption:"木栈桥伸向平静海面，蓝调晚霞与渔船倒影相映" },
  ],
  "富国岛夜市": [
  ...
  "富国岛监狱": [
    ...
    { name:"虎笼复原区", where:"展区内虎笼前，站在笼外，面向笼内复原场景。", how:"室内光线暗，手机开夜景模式；内容沉重，拍照保持肃穆，别摆搞笑pose。", sampleIndex:5, sampleCaption:"虎笼复原区，带刺铁丝笼内蜡像再现当年情景" },
