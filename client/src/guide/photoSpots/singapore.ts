export const spots: Record<string, Array<{name:string;where:string;how:string;sampleIndex?:number;sampleCaption?:string}>> = {
  ...
  "夜间动物园": [
    { name:"游园车夜游", where:"坐上夜间游园车（tram），面向窗外。", how:"约 40 分钟车程带现场解说，穿过 6 个地理分区；全园禁止闪光灯和手电。夜间光线很弱，手机成片率有限，别抱太高期待（据 aswesawit 游记）。", sampleIndex:0, sampleCaption:"夜幕中游园车穿行，马来貘在路边觅食" },
    { name:"入口 Thumbuakar 火舞表演", where:"夜间动物园入口庭院的表演区。", how:"部落风火舞表演 Thumbuakar 在入口庭院上演，表演者喷火、跳火舞；有说法称每日 19:00、20:00、21:00（周三除外），场次经常调整，以官网公布为准（据 aswesawit 游记）。", sampleIndex:1, sampleCaption:"入口 Thumbuakar 火舞表演的喷火瞬间" },
    { name:"花豹小径", where:"四条步行道之一的花豹小径（Leopard Trail），站在步道护栏前。", how:"花豹有独立的大型玻璃展区，小径上还能看到狮子、灵猫、豪猪；步行节奏自己掌控，比车上从容得多（据 aswesawit 游记、Girlstyle 指南）。", sampleIndex:2, sampleCaption:"花豹小径上的亚洲狮群" }
  ],
