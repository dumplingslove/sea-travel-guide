...
H('Sheraton Saigon Grand Opera Hotel','胡志明市','88 Dong Khoi · 喜来登 · 万豪系','官方资料 2026-09-17 已核验：88 Dong Khoi, District 1（西贡歌剧院旁，阮惠步行街核心地段）；入住 15:00、退房 12:00（官网FAQ）；淡季参考约 $175–200/晚（12 月旺季房价尚未核实）。TripAdvisor 4.5/5（约 3,769 条，胡志明市第 19/1,036 家）、Google 4.6（约 9,566 条）、Trip.com 9.2/10（约 612 条）、携程 4.6/5（625 条）。500 间客房及套房、3 家餐厅（Saigon Café、Li Bai）、行政酒廊、恒温咸水泳池；Grand Opera Tower 2025 年翻新。Sheraton Club 行政酒廊对 Platinum/Titanium/Ambassador 会员免费（含+1 宾客），多条 TripAdvisor 评价中钛金会员证实获套房升级——本店的具体品牌例外条款（早餐/酒廊/套房升级是否全额适用）尚未逐项核实，订房前以官网与前台确认为准。','Titanium 可凭 Sheraton Club 权益进酒廊；先确认早餐与套房升级条款后再下单。','Marriott','Sheraton','Marriott Bonvoy','https://www.marriott.com/en-us/hotels/sgnsi-sheraton-saigon-grand-opera-hotel/overview/','2026-09-17'),
