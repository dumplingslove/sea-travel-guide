...
{day:1,date:"12月12日 周六",city:"曼谷",title:"抵达 · 王城与湄南河",stops:[{time:"13:00",name:"入住河畔酒店",detail:"放下行李，留足跨洲飞行后的缓冲。小红书路线共识：住暹罗 Siam / Asok 素坤逸，BTS 方便、远离老城大堵车。"},{time:"15:00",name:"大皇宫与玉佛寺",detail:"6 篇路线帖共同覆盖的曼谷核心地标，从王室建筑与镇国翡翠玉佛开启泰国旅程。"},{time:"17:15",name:"卧佛寺",detail:"看46米卧佛与寺院晚光；着装需遮肩过膝。"},{time:"19:00",name:"湄南河晚餐",detail:"从水面看寺庙与河岸灯火；Asiatique 河滨夜市（4 篇路线帖）是晚餐后选项。"}],food:"首晚以河畔泰餐为主；朱拉隆功夜市是 5 篇路线帖的高频晚餐选择，若体力好可把晚餐挪过去。",tip:"抵达日不排跨城项目；大皇宫与寺庙严格执行着装要求；曼谷交通差，去机场务必至少提前 4 小时。"},
...
{day:18,date:"12月29日 周二",city:"新加坡",title:"飞新加坡 · 滨海湾",stops:[{time:"07:30",name:"经胡志明飞新加坡",detail:"预计中转，预留入境与行李时间。"},{time:"15:30",name:"鱼尾狮公园",detail:"10/10 篇路线帖地标必打卡；建议早上避开旅行团，本日下午到人会多。"},{time:"17:00",name:"滨海湾花园",detail:"9/10 篇路线帖覆盖；云雾森林强烈推荐，下午去逛完等开灯，温室是雨天可靠备份。"},{time:"19:45",name:"擎天树灯光秀",detail:"超级树夜晚灯光秀（9/10 篇）；研究快照记录场次为19:45/20:45，出发前再确认。"}],food:"Maxwell 熟食中心或 Jumbo 辣椒蟹。",tip:"12月多阵雨；把室内温室与ArtScience作为弹性替换。地铁为主，EZ-Link 卡或 Visa 信用卡直接刷，一人一卡（不能两人共用）；新加坡地铁不能用支付宝，打车贵。"},
