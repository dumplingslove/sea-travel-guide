...
'因他农国家公园':{address:'清迈西南约120公里，最高峰2565米（泰国最高峰）',hours:'每日 5:30–18:30；Kew Mae Pan 步道每年6–10月关闭',price:'外国人门票300泰铢/成人、150泰铢/儿童（官网价口径）；汽车另收30泰铢；皇家双塔另收100泰铢/人',transit:'最省心报清迈出发一日游（含酒店接送）；自驾/租摩托约2小时；公共双条车需换乘2.5–3小时以上不推荐',action:'山上景点分散必须包车/跟团，步行不现实；山顶最低约5℃带保暖衣和雨具；避开宋干节等长假（堵车）',verification:'已核验 2026-09-16'},
'大象自然公园':{address:'清迈以北约60公里 Mae Taeng 山谷（约90分钟车程）；不可自行前往，必须预约',hours:'按预约项目时间（半日游7:30–8:00/12:00接客）；每日限流，需提前1–3周预订',price:'官网价（泰铢）：半日游2500/人；SkyWalk全日游3500/人；2天1夜5800/人；Sunshine for Elephants 3500/人；Walking with Elephants 3500/人；Elephant Highlands/Care for Elephants 6000/人（不接待儿童）；一周义工15000/人；均含酒店往返接送、餐食、向导、保险',transit:'只能通过官网或市区办公室预订项目，费用含清迈酒店往返接送；不接受自行前往',action:'官网提前数周预订（每日限流）；真正无骑乘无表演的庇护所，认准官方渠道，避开名字相似的"大象营"',verification:'已核验 2026-09-16'},
...
'宁曼路':{address:'Nimmanhaemin Road, Suthep, Mueang Chiang Mai（北起 Huay Kaew 路 Maya 商场路口，向南延伸）',hours:'公共街道无开放时间；沿街店铺约10:00–22:00（One Nimman 商场11:00–22:00）',price:'免费开放；具体项目另计',transit:'古城乘红色双条车（跟司机说 Nimman / Nimman Soi 1），古城出发约30–40泰铢/人；tuk-tuk/Grab',action:'咖啡馆/买手店/文创聚集区，适合傍晚散步加晚餐；One Nimman 庭院周一/周二16:00起有跳蚤市集',verification:'已核验 2026-09-16'},
'帕辛寺':{address:'2 Sam Lan Road, Si Phum, Mueang Chiang Mai',hours:'每日约6:00–17:00（建筑开放；大院可至黄昏）',price:'外国人约20–40泰铢（Lai Kham 小堂约40泰铢），泰国人免费（帖子样本）',transit:'古城内步行可达（塔佩门沿 Ratchadamnoen 路向西约1.2公里）；古城外乘双条车/tuk-tuk',action:'肩膀膝盖遮盖、入殿脱鞋，门口可借纱笼；必看 Lai Kham 小堂19世纪兰纳壁画；与契迪龙寺步行10分钟可串游；早7:00–9:00光线好人少',verification:'已核验 2026-09-16'},
...
'Bitexco 观景台':{address:'Bitexco 金融塔，Hồ Tùng Mậu 36 号，Bến Nghé（票务页地址；楼体官方地址为 Hải Triều 2 号，观景台换票柜台在 4 层 Hải Triều 入口）',hours:'每日 9:30–21:30（售票柜台约 20:45 停止售票；最晚入场为闭馆前 45 分钟）',price:'240,000 VND/成人（OTA 样本，Klook 同产品约 NT$295）；4 岁以下免费，4–12 岁及 65 岁以上有优惠',transit:'第一郡核心位置，可步行至阮惠步行街；坐 Grab 最方便；机场 109 路公交可到附近',action:'选傍晚时段可一次看日落+夜景，提前到避免 20:45 后买不到票；观景台内禁饮食、禁宠物；工作日人比周末少',verification:'已核验 2026-09-16'},
...
'古芝地道':{address:'胡志明市古芝县，距市区西北约 50 公里；双入口 Ben Dinh（近）/ Ben Duoc（远）',hours:'每日 7:00–17:00（售票柜台约 16:00 左右关闭）',price:'门票 Ben Dinh 110,000 VND/人，Ben Duoc 90,000 VND/人（航司官网价口径）；实弹射击 60,000 VND/发（最少 600,000 VND 起，帖子样本，费用自理）；Klook 中文导览半日团约 NT$526/人（OTA 样本，含第一郡酒店接送）',transit:'最省心报半日团（第一郡酒店 7:30 接、约 14:30 返）；自助可坐公交但需转车、单程约 2.5 小时，或 Grab 包车前往',action:'报半日团足够（含接送+讲解+门票），建议选上午团避开正午暴晒；隧道低矮狭窄，幽闭恐惧/腰背不适者只参观地面展区即可；穿运动鞋、带水和防晒驱蚊',verification:'已核验 2026-09-16'},
'同起街':{address:'Đồng Khởi Street，District 1（从红教堂前巴黎公社广场到西贡河 Tôn Đức Thắng，长约 630 米）',hours:'全天开放（街道无门票无闭馆）',price:'免费开放；具体项目另计',transit:'与阮惠步行街平行，步行即达；红教堂、中央邮局、歌剧院均在步行范围内；Grab 方便',action:'胡志明最高端购物街（奢侈品店、歌剧院、老牌酒店），适合傍晚散步+看歌剧院夜景；街道单向通行，过马路注意车流',verification:'已核验 2026-09-16'},
...
'战争遗迹博物馆':{address:'Võ Văn Tần 28 号，Ward 6，District 3',hours:'每日 7:30–17:30（售票柜台约 17:00 关闭）',price:'40,000 VND/成人（官网价口径；6–15 岁儿童 20,000 VND，6 岁以下免费；Trip.com 售约 TWD61）',transit:'第一郡 Grab/出租车约 10–15 分钟；可从统一宫或红教堂步行约 10 分钟到达',action:'建议 8 点开馆即去避开旅行团，留 2–3 小时；部分展厅图片较血腥，带小孩的家长提前规划路线；户外军机展区下午光线好适合拍照',verification:'已核验 2026-09-16'},
'玉皇殿':{address:'Mai Thi Luu 73 号，Đa Kao，District 1（奥巴马 2016 年到访过的道观）',hours:'每日 7:00–18:00；农历初一、十五延长至约 5:00–19:00（法语来源记平日 7:00–17:30）',price:'免费开放；香油钱随喜',transit:'独立宫以北约 1.5 公里，Grab 约 10 分钟（约 50,000 VND 样本）；公交 18/93/150 路可达',action:'寺庙着装：遮肩盖膝，入内殿需脱鞋；殿内禁止拍照（室外可拍）；早上去人少，农历初一十五香客极多建议避开',verification:'已核验 2026-09-16'},
...
'统一宫':{address:'Nam Kỳ Khởi Nghĩa 135 号，Bến Thành，District 1（另有 Nguyen Du 106 号门）',hours:'参观每日 7:00–18:00（官网 2025-08-01 起；Nguyen Du 门 8:00–16:00）',price:'官网价：通票（含展览）成人 80,000 VND，仅宫殿 40,000 VND，电瓶车 25,000 VND/人·次，儿童 10,000–20,000 VND',transit:'距红教堂、中央邮局步行约 10 分钟；第一郡内 Grab 方便',action:'建议早上早去并蹭多语言免费讲解（有提供时）；留 1.5–2.5 小时，地下战时指挥中心是精华别错过；4 月 30 日等纪念日人极多',verification:'已核验 2026-09-16'},
'阮惠步行街':{address:'Nguyễn Huệ Street，Ben Nghe，District 1（从市政厅到西贡河滨，长 670 米、宽 64 米）',hours:'全天开放；周六、日 18:00–22:00 机动车禁行变为纯步行街',price:'免费开放；具体项目另计',transit:'第一郡核心，步行串联同起街、Bitexco；地铁 1 号线歌剧院站可达；Grab 方便',action:'晚上去最有氛围，周末封街后最佳；咖啡公寓上楼看街景喝咖啡；春节期间有花灯花街',verification:'已核验 2026-09-16'},
'中央市场':{address:'Jalan Tun Tan Cheng Lock 与 Jalan Hang Kasturi 步行街交界，50050 Kuala Lumpur',hours:'每日10:00–22:00',price:'免费入场；购物消费另计',transit:'LRT Kelana Jaya线至Pasar Seni站步行约5分钟；LRT Ampang线至Masjid Jamek站步行约10分钟；Go KL紫线巴士',action:'工作日去避开周末人流；摊位可砍价；楼上美食区尝nasi lemak/satay；注意洗手间收费；可步行串联茨厂街/独立广场',verification:'已核验 2026-09-16'},
'伊斯兰艺术博物馆':{address:'Jalan Lembah Perdana, Tasik Perdana, 50480 Kuala Lumpur',hours:'每日9:30–18:00（开斋节闭馆）',price:'成人RM20、学生/老人RM10、6岁以下免费（2024年博客样本）',transit:'LRT至Pasar Seni站步行约10分钟；MRT Muzium Negara站步行约20分钟；KL Sentral打车约5分钟',action:'东南亚最大伊斯兰艺术馆，预留1.5–2小时；着装端庄；室内拍照严禁开闪光灯',verification:'已核验 2026-09-16'},
...
'国家植物园':{address:'Jalan Kebun Bunga, Tasik Perdana, 55100 Kuala Lumpur',hours:'每日7:00–20:00',price:'免费入场；园内Bird Park/Butterfly Park等另收费',transit:'KTM Komuter至旧Kuala Lumpur站，步行经国家清真寺；巴士B115/B112/B101步行约5分钟；自KL Sentral步行路难走',action:'早晨或傍晚凉快时去；免费城市绿肺；可经地下通道步行约8分钟串联国家博物馆；园内指示牌少',verification:'已核验 2026-09-16'},
'天后宫':{address:'65 Persiaran Endah, Taman Persiaran Desa, 50460 Kuala Lumpur',hours:'每日9:00–18:00',price:'免费入场；捐赠随意',transit:'建议打车/Grab，市区约20–30分钟；在山上；公共交通：LRT至Bangsar或Mid Valley站后再打车',action:'着装端庄：遮肩盖膝，主殿需脱鞋；早晨或日落去拍照光线好，可俯瞰KL天际线',verification:'已核验 2026-09-16'},
'武吉免登':{address:'Jalan Bukit Bintang, Bukit Bintang, 55100 Kuala Lumpur',hours:'街区全天；Jalan Alor美食街约17:00–24:00（高峰19:00–22:00）',price:'免费开放；具体项目另计',transit:'MRT Kajang线Bukit Bintang站；Monorail Bukit Bintang站',action:'晚上去Jalan Alor吃宵夜（摊位约RM10–25/道，拼桌分享）；现金或QR付款；白天逛商场+街头壁画',verification:'已核验 2026-09-16'},
'独立广场':{address:'Jalan Raja, 50050 Kuala Lumpur',hours:'24小时开放',price:'免费开放；具体项目另计',transit:'LRT Kelana Jaya线/Ampang–Sri Petaling线至Masjid Jamek站步行几分钟；或Bandaraya站步行约9分钟',action:'早晨或黄昏蓝调时刻去拍照最美；中午无遮阴很晒；可步行串联中央市场、茨厂街',verification:'已核验 2026-09-16'},
...
'黑风洞':{address:'Batu Caves, Gombak, 68100 Kuala Lumpur（市区以北约13公里）',hours:'每日6:00–21:00（主庙洞6:00–21:00）',price:'主庙洞免费；Ramayana Cave RM15；Cave Villa RM15',transit:'KTM Komuter自KL Sentral直达Batu Caves站约30–40分钟RM2.60，终点即寺庙入口；Grab约RM20、15–25分钟',action:'穿遮肩盖膝服装，入口可租sarong约RM10–15；工作日早上9点前去人少凉快；看好食物防猴子抢',verification:'已核验 2026-09-16'},
...
'姓氏桥':{address:'Pengkalan Weld（Weld Quay）, 10300 George Town, Penang；最出名的是姓周桥（Chew Jetty）',hours:'姓周桥要求游客 9:00-21:00；其他桥无固定开放时间（居民区，请白天或傍晚访问）',price:'免费开放；具体项目另计（欢迎随喜捐赠）',transit:'从 Armenian Street 步行 10-15 分钟；CAT 免费巴士；Rapid Penang 101/104/201/307/401/204；或叫 Grab',action:'傍晚看日落+夜景倒影最出片；仍是住人社区：低声、走主栈道、私宅禁入、拍照先问；穿防滑鞋、带现金',verification:'已核验 2026-09-16'},
'娘惹博物馆':{address:'29 Church Street, 10200 George Town, Penang',hours:'每日 9:30-17:00（含公共假期）',price:'成人 RM25、6-12 岁儿童 RM12、6 岁以下免费；免费英文/中文导览 11:30 与 15:30（约45分钟）',transit:'遗产区步行可达（近壁画街、蓝屋）；巴士 103/204/502/CAT Jetty；或叫 Grab',action:'踩着 11:30 或 15:30 的免费中文导览进；与蓝屋+壁画街排半天；预留约 2 小时',verification:'已核验 2026-09-16'},
'极乐寺':{address:'1000-L, Tingkat Lembah Ria 1, Air Itam, 11500 Penang',hours:'每日 8:00-17:00（TripAdvisor；部分游客样本 8:30-17:30）',price:'寺院大院免费；上山斜梯/缆车与宝塔另收费（游客样本价）：到顶往返套票 RM16（含缆车+电瓶车）；第一段斜梯 RM3单程、第二段电瓶车 RM4往返、宝塔 RM4/人；停车 RM3/3小时',transit:'乔治市中心叫 Grab 约 30 分钟；有巴士但班次疏；与升旗山同在 Air Itam 可拼一天',action:'一早去避各层排队（可步行代替）；进门先往最远的观音像/宝塔走（各层开放时间不一）；着装端庄遮肩盖膝；留约 2 小时',verification:'已核验 2026-09-16'},
'Dinh Cau 岩':{address:'阳东镇Khu phố 2 / 白藤街沿岸岩石（阳东镇中心）',hours:'多来源说法不一：7:00–18:00 / 全天开放 / 7:00–20:30，以现场为准',price:'免费',transit:'镇中心步行可达，日落后步行5分钟到夜市',action:'看日落必去；29级台阶较滑注意脚下；寺庙着装得体、殿内禁拍照',verification:'已核验 2026-09-16'},
...
'Vinpearl Safari':{address:'岛北部Bãi Dài, Gành Dầu（另记Gành Dầu - Cửa Cạn）',hours:'8:30（或9:00）–16:00，不同来源略异',price:'官网调价通知2026-01-07起生效：成人85万盾，儿童/长者65万盾；Night Safari成人70万盾/儿童53万盾',transit:'免费VinBus电动班车接驳（持票乘车）；或打车包车，距阳东镇约30公里',action:'一早入园、预留3–4小时，重点坐Safari巴士+步行区；防晒驱蚊穿舒适鞋',verification:'已核验 2026-09-16'},
'安泰群岛浮潜':{address:'出海集合点：安泰港（An Thoi pier），行程覆盖Hon Thom等安泰群岛海域',hours:'无固定开放时间，看所选团行程单（典型4–8小时）',price:'OTA样本：拼团约29–39美元/人起，私团约56–230美元起；最终看所选团行程单',transit:'团多含酒店接送：阳东镇/Bai Truong/安泰免费接，其他区域加价（Ong Lang区25万盾/团起）',action:'优先选小团/私团避开大团时段，确认含浮潜装备、午餐与保险；恶劣天气会取消退款',verification:'已核验 2026-09-16'},
'富国岛夜市':{address:'主指Dinh Cau夜市：阳东镇中心Vo Thi Sau街；另有标注6 Bạch Đằng / 54 Nguyễn Trãi',hours:'每日约17:00–23:30（多摊位18:00–24:00），20:00后最热闹',price:'免门票进场按消费付费；甜品约2.5–5万盾，海鲜现秤按品项浮动',transit:'镇中心步行可达；离岛住客打车/Grab，深夜返程用叫车软件勿路边拦车',action:'先逛一圈比价再点单；海鲜现秤先问清单位与做法是否加价；看好背包防扒手',verification:'已核验 2026-09-16'},
'富国岛监狱':{address:'350 Nguyen Van Cu Street, An Thoi Ward, Phu Quoc',hours:'7:30–11:00 / 13:30–17:00（午休闭馆）；一来源记7:00–17:00无午休',price:'多来源称免费；一来源称语音导览约5万盾',transit:'岛南An Thoi，距阳东镇约30公里，打车/租摩托约40–45分钟',action:'预留1.5–2小时；展陈沉重儿童及敏感者慎入、着装得体；注意：多个OTA行程页曾标注因维护暂停开放，出行前务必再确认',verification:'已核验 2026-09-16'},
...
'星星海滩':{address:'岛东南海岸（Bãi Sao），距机场以北约16公里；无具体门牌',hours:'无官方开放时间，全天可进',price:'免费开放；具体项目另计（躺椅5–7万盾、遮阳伞3–5万盾、淡水冲洗2–4万盾）',transit:'阳东镇打车/租摩托/跟团，约40分钟–1小时',action:'带泳衣防晒与现金；椰树秋千拍照出片；常与护国寺、监狱拼南线一日游',verification:'已核验 2026-09-16'},
'鱼露工厂与胡椒园':{address:'鱼露：Khai Hoan（阳东镇Hung Vuong街）、Phung Hung（An Thoi镇Nguyen Truong To街）、Hung Thanh（阳东镇Ngo Quyen街）；胡椒园样本：Bungalow Pepper Farm（Suối Cái - Gành Dầu, Cửa Cạn）',hours:'鱼露：Hung Thanh除周日外8:00–17:00，Phung Hung 9:00–21:00；胡椒园无统一时间',price:'参观免费；鱼露售价约4.5–8.7美元/瓶',transit:'阳东镇内步行/打车可达（Hung Thanh在Duong Dong市场旁）；多含在南线一日团行程内',action:'现场可品尝比对、直接从木桶取样；气味浓烈敏感者备口罩/围巾；胡椒11月–次年2月为采收季',verification:'已核验 2026-09-16'},
...
'ArtScience Museum':{address:'6 Bayfront Avenue, Singapore 018974（滨海湾金沙内）',hours:'周日至周四 10:00–19:00（18:00停止入场）；周五至周六 10:00–21:00（20:15停止入场）',price:'票价按展览另售；OTA样本：Expedia成人约US$17起',action:'展览轮换，行前查官网当前展览并提前订票；热门展（如teamLab）建议一早去',verification:'已核验 2026-09-16'},
'Jewel 星耀樟宜':{address:'78 Airport Boulevard, Singapore 819666',hours:'综合体全天开放；付费景点约10:00–21:00，商铺约10:00–22:00',price:'免费入场；Canopy Park等收费项目OTA样本约S$4.80起',transit:'MRT东西线至Changi Airport站（CG2），经T2/T3二层连廊直达Jewel',action:'免费看40米高雨漩涡和森林谷；Canopy Park空中花园需另购票，建议预留2–3小时',verification:'已核验 2026-09-16'},
...
'Singapore Oceanarium':{address:'8 Sentosa Gateway, Sentosa, Singapore 098269（圣淘沙名胜世界）',hours:'周一至周五 10:00–19:00；周末及公众假期 09:00–21:00',price:'官网价：成人票S$49起',transit:'HarbourFront MRT转VivoCity三楼圣淘沙捷运上岛',action:'22个展区建议预留约3小时；2025年7月新开业，周末热门时段提前官网购票',verification:'已核验 2026-09-16'},
...
'圣淘沙海滩':{address:'Sentosa Island, Singapore 099008（含Siloso/Palawan/Tanjong三片海滩）',hours:'海滩全天开放；日落观赏约17:30–19:00',price:'免费开放；具体项目另计',transit:'HarbourFront MRT→VivoCity三楼圣淘沙捷运至Beach站，转免费沙滩接驳',action:'三选一：Palawan走吊桥打卡亚洲大陆最南端，Siloso玩水上运动，Tanjong人少适合野餐看日落',verification:'已核验 2026-09-16'},
...
'小印度':{address:'Serangoon Rd, Singapore 218021（小印度街区）',hours:'街区全天开放；店铺多约10:00起营业，Mustafa Centre 24小时',price:'免费开放；具体项目另计',transit:'Little India MRT（NE7/DT12），或Farrer Park站（NE8）',action:'中午去Tekka Centre吃印度餐，傍晚拍Tan Teng Niah彩色老屋；Deepavali期间人多',verification:'已核验 2026-09-16'},
'新加坡动物园与Bird Paradise':{address:'新加坡动物园：80 Mandai Lake Rd, Singapore 729826；Bird Paradise：Mandai Lake Road（同区）',hours:'动物园 08:30–18:00；Bird Paradise 09:00–18:00',price:'官网价：动物园非居民成人S$49/儿童S$34；Bird Paradise成人S$39起',transit:'MRT南北线至Khatib站（NS14）转171路公交到Mandai园区',action:'开园就到，动物上午最活跃；两园同区可安排同一天，上午动物园下午鸟园',verification:'已核验 2026-09-16'},
...
'牛车水':{address:'Pagoda St, Singapore 059203（牛车水街区）',hours:'店铺约10:00–22:00；佛牙寺一般免费入内',price:'免费开放；具体项目另计',transit:'Chinatown MRT（NE4/DT19），A出口直达宝塔街',action:'下午逛佛牙寺和宝塔街，傍晚去麦士威熟食中心吃饭；农历新年期间最热闹也最挤',verification:'已核验 2026-09-16'},
...
'鱼尾狮公园':{address:'1 Fullerton Rd, Singapore 049213',hours:'24小时开放',price:'免费开放；具体项目另计',transit:'Raffles Place MRT（EW14/NS26）H出口步行约5分钟',action:'早上7–9点或傍晚去，人少好拍照，约30分钟打卡，可衔接滨海湾夜景',verification:'已核验 2026-09-16'}
};
